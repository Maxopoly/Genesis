...
public class GenesisEnderman extends GenesisLivingEntity {
	...
	public GenesisEnderman(String uniqueTag, String customName, Map <EffectCause, List <CombatEffect>> effects) {
		super(EntityType.ENDERMAN, uniqueTag, customName, effects);
	}
